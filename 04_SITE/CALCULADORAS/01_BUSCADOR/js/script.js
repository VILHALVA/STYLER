        ...
        fetch(url, { method: 'HEAD' })
            .then(response => {
                if (response.ok) {
                    ...
                    showError(`🤬ERRO 404: A CALCULADORA \"${originalInput}\" NÃO FOI ENCONTRADA! VERIFIQUE SE O NOME ESTÁ CORRETO COM BASE NAS SUGESTÕES OU BUSQUE EM OUTROS SITES CLICANDO NO BOTÃO ABAIXO 👇`);
