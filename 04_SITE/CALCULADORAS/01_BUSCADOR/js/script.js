document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseURL = "https://vilhalva.github.io/STYLER/04_SITE/CALCULADORAS/";
        ...
        fetch(url, { method: 'HEAD' })
            .then(response => {
                if (response.ok) {
                    ...
                    showError(`🤬ERRO 404: A calculadora "${formattedInput}" não foi encontrada! Pode ter ocorrido por um dos dois motivos: 1️⃣Você pode ter digitado o nome incorreto. Verifique os títulos das calculadoras disponíveis no menu de calculadoras e tente novamente. 2️⃣A calculadora não existe neste site. 👇Clique no botão abaixo para buscar em outros sites:`);
