        ...
        fetch(url, { method: 'HEAD' })
            .then(response => {
                if (response.ok) {
                    ...
                    showError(`🤬ERRO 404: O SITE \"${originalInput}\" NÃO FOI ENCONTRADO! VERIFIQUE SE O NOME ESTÁ CORRETO COM BASE NAS SUGESTÕES OU BUSQUE EM OUTROS SITES CLICANDO NO BOTÃO ABAIXO 👇`);
