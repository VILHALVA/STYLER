        ...
        fetch(url, { method: 'HEAD' })
            .then(response => {
                if (response.ok) {
                    ...
                    showError(`🤬ERRO 404: O site "${formattedInput}" não foi encontrado! Pode ter ocorrido por um dos dois motivos:\n 1️⃣ Você pode ter digitado o nome incorreto. Verifique os títulos dos sites disponíveis no menu de sites e tente novamente. (Não se esqueça do UTF-8).\n 2️⃣ O site não existe aqui. Clique no botão abaixo para buscar em outros google:`);
