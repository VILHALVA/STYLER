document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseURL = "https://vilhalva.github.io/STYLER/04_SITE/CHATBOTS/";
        ...
        fetch(url, { method: 'HEAD' })
            .then(response => {
                if (response.ok) {
                    ...
                    showError(`🤬ERRO 404: O CHATBOT \"${originalInput}\" NÃO FOI ENCONTRADO! VERIFIQUE SE O NOME ESTÁ CORRETO COM BASE NAS SUGESTÕES OU BUSQUE EM OUTROS SITES CLICANDO NO BOTÃO ABAIXO 👇`);
